...
class BackToTop extends Component {
  ...
  backToTop() {
    let T = setInterval(() => {
      if (document.body.scrollTop) {
        ...
        document.body.scrollTop < 0 ? document.body.scrollTop = 0 : void 0;
        document.body.scrollTop === 0 ? clearTimeout(T) : void 0;
      } else if (document.documentElement.scrollTop) {
        document.documentElement.scrollTop = document.documentElement.scrollTop - 100;
        document.documentElement.scrollTop < 0 ? document.documentElement.scrollTop = 0 : void 0;
        document.documentElement.scrollTop === 0 ? clearTimeout(T) : void 0;
      }
    }, 20);
  }
  ...
  render() {
    return (
      <div id="backtotop" style={{display: this.state.isShowed ? 'bloack' : 'none', top: '669px', right: '0px'}} onClick={this.state.isShowed ? this.backToTop : void 0}>
        回到顶部
      </div>
    )
  }
